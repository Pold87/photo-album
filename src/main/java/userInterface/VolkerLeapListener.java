...
import main.java.gesturerecognition.DrawingPanel;
	...
	private void updateRightHand(Frame frame, Hand hand) {
		...
		if (hand.isRight()) {
			...
			*/
			...
			System.out.println("The real x: ");
			System.out.println(normalizedPos.getX());
			System.out.println("The real y: ");
			System.out.println(normalizedPos.getY());
			...
			System.out.println("X in Volkers Leap Listener " + rightHandXPos);
...
//				contentPanel.setToolMode(BasicDesign.ToolMode.MOVE);
				contentPanel.updateMe(rightHandXPos, rightHandYPos);
				break;
			case 2: // ROTATE
